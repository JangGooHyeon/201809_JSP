...
<body>
<%--
   select 변경(ko-jo)--> 서버 요청 ???
   1. select로 변경한 로케일이 설정된 selectLang.jsp가 화면에 출력하도록
   2. select box option태그가 요청한 로케일이 선택이 되도록 설정
...
<form id="frm" action="${pageContext.request.contextPath}/SelectLangController">
